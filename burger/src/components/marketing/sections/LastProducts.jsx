...
function LastProducts() {
  return (
        <Container>
            <div className="grid lg:grid-cols-2 lg:grid-rows-2 gap-3 lg:gap-9 w-full h-96 px-11 my-20 text-white uppercase tracking-wider">
                <div className="relative lg:row-span-2 bg-yellow h-full rounded-md p-5 lg:p-7">
                ...
                <div className="relative bg-yellow h-full rounded-md p-5 lg:p-7">
